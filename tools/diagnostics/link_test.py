...
"""Will the Pi's 300 ms watchdog survive THIS network? Measure it, don't guess.
    ...
    .venv/bin/python tools/diagnostics/link_test.py retriever-pi.local:7777 --seconds 120
...
def main() -> int:
    ...
    if silent_seconds or closed_early or tail > wd:
        ...
        print("  jitter, and no watchdog setting fixes it. Run tools/diagnostics/pi_doctor.sh.")
        return 1
    if trips:
