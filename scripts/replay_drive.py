...
"""Play a recorded drive back into the dashboard, as if the robot were driving it again.
    ...
    python3 scripts/replay_drive.py data/drives/drive-20260920-033710.jsonl --list
    python3 scripts/replay_drive.py data/drives/drive-20260920-033710.jsonl --segment 4 \\
