...
"""The same voice turn as `mac_voice.py`, but on OpenAI instead of Qwen-Omni.
    ...
    python3 scripts/voice_openai.py                      # one turn, fixed 4 s
    python3 scripts/voice_openai.py --push-to-talk
    python3 scripts/voice_openai.py --mode direct       # one gpt-audio call
    python3 scripts/voice_openai.py --bench 3 --say "go get that goose"
...
from retriever.voice.mac import _cue                          # same laptop, same beep
